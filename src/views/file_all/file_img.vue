                        ...
                        <div class="thumbnail_item_top clearfix" v-show="currthumbindex==index || item.isChecked">
                            ...
                            <el-dropdown class="file_body_table_dropdown radio_more fr" trigger="click" placement="right-start">
                                ...
                                <el-dropdown-menu slot="dropdown">
                                    ...
                                    <el-dropdown-item v-if="isRbac_fileRoot" @click.native="handleSetRootwj(item,0)">设置权限</el-dropdown-item>
                                    <el-dropdown-item v-if="isRbac_rename" @click.native="handleRenameWj(item)">重命名</el-dropdown-item>
                                    <el-dropdown-item v-if="isRbac_remove" @click.native="handleRomoveWj(item)">移动到</el-dropdown-item>
                                    <el-dropdown-item v-if="isRbac_copy" @click.native="handleCopyWj(item)">复制到</el-dropdown-item>
                                    <el-dropdown-item v-if="isRbac_del" @click.native="handleDeleteWj(item.fileTarId)">删除</el-dropdown-item>
                                </el-dropdown-menu>
                            </el-dropdown>
                        </div>
...
export default {
  ...
  data() {
    return {
        ...
        copy_data:'',
        //数据参数
        file_type:2, //文件类型 0文件夹/文档1/图片2/音乐3/视频4/其他5
        keywords:'',

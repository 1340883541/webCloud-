...
import { uploadFile, abortFunc } from "../api/up_websocket";
...
export default {
  ...
  methods: {
    ...
    selectFile(event) {
        ...
        let that = this,totalSize = 0, g_size = 1024*1024*1024 // 1G;
        ...
        if(totalSize < g_size){
            ...
            var fileList_length = event.target.files.length

            // console.log(fileList[0])
            // console.log(fileList[1])
            // uploadFile(fileList,(i, startSize, endSize)=>{
            //     //收到服务器上传文件消息后响应回调
            //     // console.log('回调进入')
            //     // console.log(fileList)
            //     // console.log(fileList_length)
            //     // console.log('i-----'+i)
            //     // for (let g = 0; g < fileList_length; g++) {
            //     //     console.log('g----'+g)
            //     //     console.log(endSize+'----endSize')
            //     //     console.log("fileList[g].size:" + fileList[g].size);
            //     //     if (endSize < fileList[g].size) {
            //     //         console.log("fileList[g].size:" + fileList[g].size);
            ...
            //     //         //   ws.send('啊啊啊啊啊啊啊啊');
            //     //         // }
            //     //         that.loadNext(i, fileList[g]);
            //     //     } else {
            //     //         console.log("endSize >= fileList[g].size-->" + e.data + "<---");
            //     //         console.log("endSize >= fileList[g].size-->endSize:" + endSize);
            //     //         console.log("endSize >= fileList[g].size-->fileList[g].size:" + fileList[g].size);
            //     //         startSize = endSize = 0;
            //     //         i = 0;
            //     //         console.log("发送" + fileList[g].name + "完毕");
            //     //         console.log("发送文件完毕");
    ...
    loadNext (chunkSeq, file) {
        ...
        var ArrayBuffer = evt.target.result;
        console.log("发送文件第" + (chunkSeq) + "部分");
        console.log(ArrayBuffer)
        // ws.send(ArrayBuffer);
        that.ws.send('啊啊啊啊啊啊啊啊');
        }
        //切割文件大小
